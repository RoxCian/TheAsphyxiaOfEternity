import { Component, ElementRef, inject, model, signal, viewChild, viewChildren } from "@angular/core"
...
@Component({
    selector: "rb-record-popup-content-all-chart",
    templateUrl: "./rb-record-popup-content-all-chart.component.html",
    styleUrl: "./rb-record-popup-content-all-chart.component.sass",
    host: {
...
export class RbRecordPopupContentAllChartComponent<TVersion extends RbVersion> {
    ...
    private readonly jacketElement = viewChild<ElementRef<HTMLElement>>("jacketLarge")
    ...
    protected readonly backgroundSwipeAnimationParams = signal(VSwipeAnimationParams)
