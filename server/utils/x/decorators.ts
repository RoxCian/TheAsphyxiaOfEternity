...
export namespace XD {
    ...
    export function prop<T, TXType extends XTypeExtended, TTarget = T, TXKey extends string | undefined = undefined>(xType: TXType, xKey?: TXKey, type?: Type<T> | TypeToken<T>, convert?: (source: T) => TTarget, convertBack?: (target: TTarget) => T, fallbackValue?: T, elType?: T extends Array<infer TE> ? Type<TE> | TypeToken<TE> : undefined, subMap?: XSubMap<T>, elSubMap?: T extends Array<infer TE> ? XSubMap<TE> : undefined, side?: "x" | "o"): PropertyDecorator {
    ...
    export function s8<TTarget = NumberOrArray, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: NumberOrArray) => TTarget, convertBack?: (target: TTarget) => NumberOrArray, fallbackValue?: NumberOrArray): PropertyDecorator
    export function s8<TTarget = NumberOrArray, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: NumberOrArray) => TTarget, convertBack?: (target: TTarget) => NumberOrArray, fallbackValue?: NumberOrArray): PropertyDecorator {
    ...
    export function u8<TTarget = NumberOrArray, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: NumberOrArray) => TTarget, convertBack?: (target: TTarget) => NumberOrArray, fallbackValue?: NumberOrArray): PropertyDecorator
    export function u8<TTarget = NumberOrArray, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: NumberOrArray) => TTarget, convertBack?: (target: TTarget) => NumberOrArray, fallbackValue?: NumberOrArray): PropertyDecorator {
    ...
    export function s16<TTarget = NumberOrArray, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: NumberOrArray) => TTarget, convertBack?: (target: TTarget) => NumberOrArray, fallbackValue?: NumberOrArray): PropertyDecorator
    export function s16<TTarget = NumberOrArray, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: NumberOrArray) => TTarget, convertBack?: (target: TTarget) => NumberOrArray, fallbackValue?: NumberOrArray): PropertyDecorator {
    ...
    export function u16<TTarget = NumberOrArray, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: NumberOrArray) => TTarget, convertBack?: (target: TTarget) => NumberOrArray, fallbackValue?: NumberOrArray): PropertyDecorator
    export function u16<TTarget = NumberOrArray, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: NumberOrArray) => TTarget, convertBack?: (target: TTarget) => NumberOrArray, fallbackValue?: NumberOrArray): PropertyDecorator {
    ...
    export function s32<TTarget = NumberOrArray, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: NumberOrArray) => TTarget, convertBack?: (target: TTarget) => NumberOrArray, fallbackValue?: NumberOrArray): PropertyDecorator
    export function s32<TTarget = NumberOrArray, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: NumberOrArray) => TTarget, convertBack?: (target: TTarget) => NumberOrArray, fallbackValue?: NumberOrArray): PropertyDecorator {
    ...
    export function u32<TTarget = NumberOrArray, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: NumberOrArray) => TTarget, convertBack?: (target: TTarget) => NumberOrArray, fallbackValue?: NumberOrArray): PropertyDecorator
    export function u32<TTarget = NumberOrArray, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: NumberOrArray) => TTarget, convertBack?: (target: TTarget) => NumberOrArray, fallbackValue?: NumberOrArray): PropertyDecorator {
    ...
    export function s64<TTarget = BigIntOrArray, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: BigIntOrArray) => TTarget, convertBack?: (target: TTarget) => BigIntOrArray, fallbackValue?: BigIntOrArray): PropertyDecorator
    export function s64<TTarget = BigIntOrArray, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: BigIntOrArray) => TTarget, convertBack?: (target: TTarget) => BigIntOrArray, fallbackValue?: BigIntOrArray): PropertyDecorator {
    ...
    export function u64<TTarget = BigIntOrArray, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: BigIntOrArray) => TTarget, convertBack?: (target: TTarget) => BigIntOrArray, fallbackValue?: BigIntOrArray): PropertyDecorator
    export function u64<TTarget = BigIntOrArray, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: BigIntOrArray) => TTarget, convertBack?: (target: TTarget) => BigIntOrArray, fallbackValue?: BigIntOrArray): PropertyDecorator {
    ...
    export function float<TTarget = NumberOrArray, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: NumberOrArray) => TTarget, convertBack?: (target: TTarget) => NumberOrArray, fallbackValue?: NumberOrArray): PropertyDecorator
    export function float<TTarget = NumberOrArray, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: NumberOrArray) => TTarget, convertBack?: (target: TTarget) => NumberOrArray, fallbackValue?: NumberOrArray): PropertyDecorator {
    ...
    export function double<TTarget = NumberOrArray, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: NumberOrArray) => TTarget, convertBack?: (target: TTarget) => NumberOrArray, fallbackValue?: NumberOrArray): PropertyDecorator
    export function double<TTarget = NumberOrArray, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: NumberOrArray) => TTarget, convertBack?: (target: TTarget) => NumberOrArray, fallbackValue?: NumberOrArray): PropertyDecorator {
    ...
    export function bool<TTarget = BooleanOrArray, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: BooleanOrArray) => TTarget, convertBack?: (target: TTarget) => BooleanOrArray, fallbackValue?: BooleanOrArray): PropertyDecorator
    export function bool<TTarget = BooleanOrArray, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: BooleanOrArray) => TTarget, convertBack?: (target: TTarget) => BooleanOrArray, fallbackValue?: BooleanOrArray): PropertyDecorator {
    ...
    export function v2s8<TTarget = Vector2, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector2) => TTarget, convertBack?: (target: TTarget) => Vector2, fallbackValue?: Vector2): PropertyDecorator
    export function v2s8<TTarget = Vector2, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector2) => TTarget, convertBack?: (target: TTarget) => Vector2, fallbackValue?: Vector2): PropertyDecorator {
    ...
    export function v2u8<TTarget = Vector2, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector2) => TTarget, convertBack?: (target: TTarget) => Vector2, fallbackValue?: Vector2): PropertyDecorator
    export function v2u8<TTarget = Vector2, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector2) => TTarget, convertBack?: (target: TTarget) => Vector2, fallbackValue?: Vector2): PropertyDecorator {
    ...
    export function v2s16<TTarget = Vector2, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector2) => TTarget, convertBack?: (target: TTarget) => Vector2, fallbackValue?: Vector2): PropertyDecorator
    export function v2s16<TTarget = Vector2, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector2) => TTarget, convertBack?: (target: TTarget) => Vector2, fallbackValue?: Vector2): PropertyDecorator {
    ...
    export function v2u16<TTarget = Vector2, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector2) => TTarget, convertBack?: (target: TTarget) => Vector2, fallbackValue?: Vector2): PropertyDecorator
    export function v2u16<TTarget = Vector2, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector2) => TTarget, convertBack?: (target: TTarget) => Vector2, fallbackValue?: Vector2): PropertyDecorator {
    ...
    export function v2s32<TTarget = Vector2, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector2) => TTarget, convertBack?: (target: TTarget) => Vector2, fallbackValue?: Vector2): PropertyDecorator
    export function v2s32<TTarget = Vector2, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector2) => TTarget, convertBack?: (target: TTarget) => Vector2, fallbackValue?: Vector2): PropertyDecorator {
    ...
    export function v2u32<TTarget = Vector2, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector2) => TTarget, convertBack?: (target: TTarget) => Vector2, fallbackValue?: Vector2): PropertyDecorator
    export function v2u32<TTarget = Vector2, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector2) => TTarget, convertBack?: (target: TTarget) => Vector2, fallbackValue?: Vector2): PropertyDecorator {
    ...
    export function v2s64<TTarget = Vector2, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector2B) => TTarget, convertBack?: (target: TTarget) => Vector2B, fallbackValue?: Vector2B): PropertyDecorator
    export function v2s64<TTarget = Vector2, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector2B) => TTarget, convertBack?: (target: TTarget) => Vector2B, fallbackValue?: Vector2B): PropertyDecorator {
    ...
    export function v2u64<TTarget = Vector2, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector2B) => TTarget, convertBack?: (target: TTarget) => Vector2B, fallbackValue?: Vector2B): PropertyDecorator
    export function v2u64<TTarget = Vector2, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector2B) => TTarget, convertBack?: (target: TTarget) => Vector2B, fallbackValue?: Vector2B): PropertyDecorator {
    ...
    export function v2f<TTarget = Vector2, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector2) => TTarget, convertBack?: (target: TTarget) => Vector2, fallbackValue?: Vector2): PropertyDecorator
    export function v2f<TTarget = Vector2, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector2) => TTarget, convertBack?: (target: TTarget) => Vector2, fallbackValue?: Vector2): PropertyDecorator {
    ...
    export function v2d<TTarget = Vector2, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector2) => TTarget, convertBack?: (target: TTarget) => Vector2, fallbackValue?: Vector2): PropertyDecorator
    export function v2d<TTarget = Vector2, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector2) => TTarget, convertBack?: (target: TTarget) => Vector2, fallbackValue?: Vector2): PropertyDecorator {
    ...
    export function v2b<TTarget = Vector2, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector2) => TTarget, convertBack?: (target: TTarget) => Vector2, fallbackValue?: Vector2): PropertyDecorator
    export function v2b<TTarget = Vector2, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector2) => TTarget, convertBack?: (target: TTarget) => Vector2, fallbackValue?: Vector2): PropertyDecorator {
    ...
    export function v3s8<TTarget = Vector3, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector3) => TTarget, convertBack?: (target: TTarget) => Vector3, fallbackValue?: Vector3): PropertyDecorator
    export function v3s8<TTarget = Vector3, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector3) => TTarget, convertBack?: (target: TTarget) => Vector3, fallbackValue?: Vector3): PropertyDecorator {
    ...
    export function v3u8<TTarget = Vector3, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector3) => TTarget, convertBack?: (target: TTarget) => Vector3, fallbackValue?: Vector3): PropertyDecorator
    export function v3u8<TTarget = Vector3, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector3) => TTarget, convertBack?: (target: TTarget) => Vector3, fallbackValue?: Vector3): PropertyDecorator {
    ...
    export function v3s16<TTarget = Vector3, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector3) => TTarget, convertBack?: (target: TTarget) => Vector3, fallbackValue?: Vector3): PropertyDecorator
    export function v3s16<TTarget = Vector3, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector3) => TTarget, convertBack?: (target: TTarget) => Vector3, fallbackValue?: Vector3): PropertyDecorator {
    ...
    export function v3u16<TTarget = Vector3, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector3) => TTarget, convertBack?: (target: TTarget) => Vector3, fallbackValue?: Vector3): PropertyDecorator
    export function v3u16<TTarget = Vector3, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector3) => TTarget, convertBack?: (target: TTarget) => Vector3, fallbackValue?: Vector3): PropertyDecorator {
    ...
    export function v3s32<TTarget = Vector3, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector3) => TTarget, convertBack?: (target: TTarget) => Vector3, fallbackValue?: Vector3): PropertyDecorator
    export function v3s32<TTarget = Vector3, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector3) => TTarget, convertBack?: (target: TTarget) => Vector3, fallbackValue?: Vector3): PropertyDecorator {
    ...
    export function v3u32<TTarget = Vector3, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector3) => TTarget, convertBack?: (target: TTarget) => Vector3, fallbackValue?: Vector3): PropertyDecorator
    export function v3u32<TTarget = Vector3, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector3) => TTarget, convertBack?: (target: TTarget) => Vector3, fallbackValue?: Vector3): PropertyDecorator {
    ...
    export function v3s64<TTarget = Vector3, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector3B) => TTarget, convertBack?: (target: TTarget) => Vector3B, fallbackValue?: Vector3B): PropertyDecorator
    export function v3s64<TTarget = Vector3, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector3B) => TTarget, convertBack?: (target: TTarget) => Vector3B, fallbackValue?: Vector3B): PropertyDecorator {
    ...
    export function v3u64<TTarget = Vector3, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector3B) => TTarget, convertBack?: (target: TTarget) => Vector3B, fallbackValue?: Vector3B): PropertyDecorator
    export function v3u64<TTarget = Vector3, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector3B) => TTarget, convertBack?: (target: TTarget) => Vector3B, fallbackValue?: Vector3B): PropertyDecorator {
    ...
    export function v3f<TTarget = Vector3, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector3) => TTarget, convertBack?: (target: TTarget) => Vector3, fallbackValue?: Vector3): PropertyDecorator
    export function v3f<TTarget = Vector3, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector3) => TTarget, convertBack?: (target: TTarget) => Vector3, fallbackValue?: Vector3): PropertyDecorator {
    ...
    export function v3d<TTarget = Vector3, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector3) => TTarget, convertBack?: (target: TTarget) => Vector3, fallbackValue?: Vector3): PropertyDecorator
    export function v3d<TTarget = Vector3, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector3) => TTarget, convertBack?: (target: TTarget) => Vector3, fallbackValue?: Vector3): PropertyDecorator {
    ...
    export function v3b<TTarget = Vector3, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector3) => TTarget, convertBack?: (target: TTarget) => Vector3, fallbackValue?: Vector3): PropertyDecorator
    export function v3b<TTarget = Vector3, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector3) => TTarget, convertBack?: (target: TTarget) => Vector3, fallbackValue?: Vector3): PropertyDecorator {
    ...
    export function v4s8<TTarget = Vector4, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector4) => TTarget, convertBack?: (target: TTarget) => Vector4, fallbackValue?: Vector4): PropertyDecorator
    export function v4s8<TTarget = Vector4, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector4) => TTarget, convertBack?: (target: TTarget) => Vector4, fallbackValue?: Vector4): PropertyDecorator {
    ...
    export function v4u8<TTarget = Vector4, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector4) => TTarget, convertBack?: (target: TTarget) => Vector4, fallbackValue?: Vector4): PropertyDecorator
    export function v4u8<TTarget = Vector4, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector4) => TTarget, convertBack?: (target: TTarget) => Vector4, fallbackValue?: Vector4): PropertyDecorator {
    ...
    export function v4s16<TTarget = Vector4, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector4) => TTarget, convertBack?: (target: TTarget) => Vector4, fallbackValue?: Vector4): PropertyDecorator
    export function v4s16<TTarget = Vector4, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector4) => TTarget, convertBack?: (target: TTarget) => Vector4, fallbackValue?: Vector4): PropertyDecorator {
    ...
    export function v4u16<TTarget = Vector4, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector4) => TTarget, convertBack?: (target: TTarget) => Vector4, fallbackValue?: Vector4): PropertyDecorator
    export function v4u16<TTarget = Vector4, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector4) => TTarget, convertBack?: (target: TTarget) => Vector4, fallbackValue?: Vector4): PropertyDecorator {
    ...
    export function v4s32<TTarget = Vector4, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector4) => TTarget, convertBack?: (target: TTarget) => Vector4, fallbackValue?: Vector4): PropertyDecorator
    export function v4s32<TTarget = Vector4, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector4) => TTarget, convertBack?: (target: TTarget) => Vector4, fallbackValue?: Vector4): PropertyDecorator {
    ...
    export function v4u32<TTarget = Vector4, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector4) => TTarget, convertBack?: (target: TTarget) => Vector4, fallbackValue?: Vector4): PropertyDecorator
    export function v4u32<TTarget = Vector4, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector4) => TTarget, convertBack?: (target: TTarget) => Vector4, fallbackValue?: Vector4): PropertyDecorator {
    ...
    export function v4s64<TTarget = Vector4, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector4B) => TTarget, convertBack?: (target: TTarget) => Vector4B, fallbackValue?: Vector4B): PropertyDecorator
    export function v4s64<TTarget = Vector4, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector4B) => TTarget, convertBack?: (target: TTarget) => Vector4B, fallbackValue?: Vector4B): PropertyDecorator {
    ...
    export function v4u64<TTarget = Vector4, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector4B) => TTarget, convertBack?: (target: TTarget) => Vector4B, fallbackValue?: Vector4B): PropertyDecorator
    export function v4u64<TTarget = Vector4, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector4B) => TTarget, convertBack?: (target: TTarget) => Vector4B, fallbackValue?: Vector4B): PropertyDecorator {
    ...
    export function v4f<TTarget = Vector4, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector4) => TTarget, convertBack?: (target: TTarget) => Vector4, fallbackValue?: Vector4): PropertyDecorator
    export function v4f<TTarget = Vector4, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector4) => TTarget, convertBack?: (target: TTarget) => Vector4, fallbackValue?: Vector4): PropertyDecorator {
    ...
    export function v4d<TTarget = Vector4, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector4) => TTarget, convertBack?: (target: TTarget) => Vector4, fallbackValue?: Vector4): PropertyDecorator
    export function v4d<TTarget = Vector4, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector4) => TTarget, convertBack?: (target: TTarget) => Vector4, fallbackValue?: Vector4): PropertyDecorator {
    ...
    export function v4b<TTarget = Vector4, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector4) => TTarget, convertBack?: (target: TTarget) => Vector4, fallbackValue?: Vector4): PropertyDecorator
    export function v4b<TTarget = Vector4, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector4) => TTarget, convertBack?: (target: TTarget) => Vector4, fallbackValue?: Vector4): PropertyDecorator {
    ...
    export function vs8<TTarget = VectorB, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: VectorB) => TTarget, convertBack?: (target: TTarget) => VectorB, fallbackValue?: VectorB): PropertyDecorator
    export function vs8<TTarget = VectorB, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: VectorB) => TTarget, convertBack?: (target: TTarget) => VectorB, fallbackValue?: VectorB): PropertyDecorator {
    ...
    export function vu8<TTarget = VectorB, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: VectorB) => TTarget, convertBack?: (target: TTarget) => VectorB, fallbackValue?: VectorB): PropertyDecorator
    export function vu8<TTarget = VectorB, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: VectorB) => TTarget, convertBack?: (target: TTarget) => VectorB, fallbackValue?: VectorB): PropertyDecorator {
    ...
    export function vs16<TTarget = VectorB, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: VectorB) => TTarget, convertBack?: (target: TTarget) => VectorB, fallbackValue?: VectorB): PropertyDecorator
    export function vs16<TTarget = VectorB, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: VectorB) => TTarget, convertBack?: (target: TTarget) => VectorB, fallbackValue?: VectorB): PropertyDecorator {
    ...
    export function vu16<TTarget = VectorB, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: VectorB) => TTarget, convertBack?: (target: TTarget) => VectorB, fallbackValue?: VectorB): PropertyDecorator
    export function vu16<TTarget = VectorB, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: VectorB) => TTarget, convertBack?: (target: TTarget) => VectorB, fallbackValue?: VectorB): PropertyDecorator {
    ...
    export function vb<TTarget = Vector, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector) => TTarget, convertBack?: (target: TTarget) => Vector, fallbackValue?: Vector): PropertyDecorator
    export function vb<TTarget = Vector, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Vector) => TTarget, convertBack?: (target: TTarget) => Vector, fallbackValue?: Vector): PropertyDecorator {
    ...
    export function bin<TTarget = Buffer, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Buffer) => TTarget, convertBack?: (target: TTarget) => Buffer, fallbackValue?: Buffer): PropertyDecorator
    export function bin<TTarget = Buffer, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Buffer) => TTarget, convertBack?: (target: TTarget) => Buffer, fallbackValue?: Buffer): PropertyDecorator {
    ...
    export function ip4<TTarget = number[], TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: number[]) => TTarget, convertBack?: (target: TTarget) => number[], fallbackValue?: number[]): PropertyDecorator
    export function ip4<TTarget = number[], TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: number[]) => TTarget, convertBack?: (target: TTarget) => number[], fallbackValue?: number[]): PropertyDecorator {
    ...
    export function str<TTarget = string, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: string) => TTarget, convertBack?: (target: TTarget) => string, fallbackValue?: string): PropertyDecorator
    export function str<TTarget = string, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: string) => TTarget, convertBack?: (target: TTarget) => string, fallbackValue?: string): PropertyDecorator {
    ...
    export function time<TTarget = Date, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Date) => TTarget, convertBack?: (target: TTarget) => Date, fallbackValue?: Date): PropertyDecorator
    export function time<TTarget = Date, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: Date) => TTarget, convertBack?: (target: TTarget) => Date, fallbackValue?: Date): PropertyDecorator {
    ...
    export function attr<TTarget = string, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: string) => TTarget, convertBack?: (target: TTarget) => string, fallbackValue?: string): PropertyDecorator
    export function attr<TTarget = string, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: string) => TTarget, convertBack?: (target: TTarget) => string, fallbackValue?: string): PropertyDecorator {
    ...
    export function obj<T extends object, TTarget = T, TXKey extends string | undefined = undefined>(xKey?: TXKey, type?: Type<any>, convert?: (source: T) => TTarget, convertBack?: (target: TTarget) => T, fallbackValue?: T): PropertyDecorator
    export function obj<T extends object, TTarget = T, TXKey extends string | undefined = undefined>(xKeyOrSubMap?: TXKey | XSubMap<T>, typeOrSubMap?: Type<any> | XSubMap<T>, convert?: (source: T) => TTarget, convertBack?: (target: TTarget) => T, fallbackValue?: T, subMap?: XSubMap<T>): PropertyDecorator {
        if (typeof xKeyOrSubMap !== "string") return prop(undefined, undefined, undefined, undefined, undefined, undefined, undefined, xKeyOrSubMap as XSubMap<T>)
    ...
    export function a<TE, TTarget = TE[], TXKey extends string | undefined = undefined>(elMap: XMap<TE, XTypeExtended>, xKey?: TXKey, convert?: (source: TE[]) => TTarget, convertBack?: (target: TTarget) => TE[], fallbackValue?: TE[]): PropertyDecorator
    export function a<TE, TTarget = TE[], TXKey extends string | undefined = undefined>(elMapOrType: Type<TE> | TypeToken<TE> | XMap<TE, XTypeExtended>, xKey?: TXKey, convert?: (source: TE[]) => TTarget, convertBack?: (target: TTarget) => TE[], fallbackValue?: TE[]): PropertyDecorator {
        let map: XMap<TE, XTypeExtended> | undefined = undefined
        let type: Type<TE> | TypeToken<TE> | undefined = undefined
        if (!isTypeOrToken(elMapOrType)) map = elMapOrType
        else type = elMapOrType
        return prop(undefined, xKey, undefined, convert, convertBack, fallbackValue, type, undefined, map as XSubMap<TE>)
    }
    // wrapped array
    ...
    export function aw<TE, TXKey extends string | undefined = undefined>(xKeyOrWrapperKey: string | TXKey, wrapperKeyOrElType: string | Type<TE>, elTypeOrMap?: Type<TE> | TypeToken<TE> | XMap<unknown, XTypeExtended>, map?: XMap<unknown, XTypeExtended>): PropertyDecorator { // array wrapper, structure like { key?: Type[] }
        ...
        return prop<ArrayWrapper<string, TE>, undefined, ArrayWrapper<string, TE>, TXKey>(undefined, xKey, c as Type<ArrayWrapper<string, TE>>, undefined, undefined, {}, undefined, undefined)
    }
    ...
    export namespace ToX {
        ...
        export function a<TE, TTarget = TE[], TXKey extends string | undefined = undefined>(elMapOrType: Type<TE> | XMap<TE, XTypeExtended, unknown>, xKey?: TXKey, convert?: (source: TE[]) => TTarget, convertBack?: (target: TTarget) => TE[], fallbackValue?: TE[]): PropertyDecorator {
            let map: XMap<TE, XTypeExtended, unknown> | undefined = undefined
            let type: Type<TE> | TypeToken<TE> | undefined = undefined
            if (!isTypeOrToken(elMapOrType)) map = elMapOrType
            else type = elMapOrType
            return prop(undefined, xKey, undefined, convert, convertBack, fallbackValue, type, undefined, map as XSubMap<TE>, "x")
        }
        ...
        export function aw<TE, TXKey extends string | undefined = undefined>(xKeyOrWrapperKey: string | TXKey, wrapperKeyOrElType: string | Type<TE>, elTypeOrMap?: Type<TE> | TypeToken<TE> | XMap<unknown, XTypeExtended>, map?: XMap<unknown, XTypeExtended>): PropertyDecorator { // array wrapper, structure like { key?: Type[] }
            ...
            return prop<ArrayWrapper<string, TE>, undefined, ArrayWrapper<string, TE>, TXKey>(undefined, xKey, c as Type<ArrayWrapper<string, TE>>, undefined, undefined, {}, undefined, undefined, undefined, "x")
        }
        export function ignore(): PropertyDecorator {
    ...
    export namespace ToO {
        ...
        export function a<TE, TTarget = TE[], TXKey extends string | undefined = undefined>(elMapOrType: Type<TE> | XMap<TE, XTypeExtended, unknown>, xKey?: TXKey, convert?: (source: TE[]) => TTarget, convertBack?: (target: TTarget) => TE[], fallbackValue?: TE[]): PropertyDecorator {
            ...
            return prop(undefined, xKey, undefined, convert, convertBack, fallbackValue, type, undefined, map as XSubMap<TE>, "o")
        }
        export function aw<TE>(wrapperKey: string, elType: Type<TE>, map?: XMap<unknown, XTypeExtended>): PropertyDecorator
        export function aw<TE, TXKey extends string>(xKey: TXKey, wrapperKey: string, elType: Type<TE>, map?: XMap<unknown, XTypeExtended>): PropertyDecorator
        export function aw<TE, TXKey extends string | undefined = undefined>(xKeyOrWrapperKey: string | TXKey, wrapperKeyOrElType: string | Type<TE>, elTypeOrMap?: Type<TE> | TypeToken<TE> | XMap<unknown, XTypeExtended>, map?: XMap<unknown, XTypeExtended>): PropertyDecorator { // array wrapper, structure like { key?: Type[] }
            ...
            return prop<ArrayWrapper<string, TE>, undefined, ArrayWrapper<string, TE>, TXKey>(undefined, xKey, c as Type<ArrayWrapper<string, TE>>, undefined, undefined, {}, undefined, undefined, undefined, "o")
        }
        export function ignore(): PropertyDecorator {
