...
export function shiftjisToUtf8(str: string): string {
    ...
    do {
        ...
        for (const l of shiftjisMap) {
            if ((c >= l.start) && c <= l.end) resultCode.push(l.library.charCodeAt(c - l.start))
        }
