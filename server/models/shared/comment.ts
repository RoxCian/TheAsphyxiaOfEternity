...
export class RbCommentBase<TVersion extends RbVersion> implements ICollection<"rb.info.comment">, RbComment<TVersion> {
    readonly collection = "rb.info.comment"
    version: TVersion
    @XD.s32("eid") entryId = 0
    @XD.s32("uid") userId: number
    @XD.str() name: string
    @XD.s8("bln") balloon = RbCommentBalloon.default
...
export class Rb2Comment extends RbCommentBase<2> {
    @XD.str("p_name") name = ""
...
export class Rb3Comment extends RbCommentBase<3> {
    @XD.s16("icon") iconId = 0
    @XD.s32("tid") teamId = 0
    @XD.str("t_name") teamName = "Asphyxia"
}
export class Rb4Comment extends RbCommentBase<4> {
    @XD.s16("icon") iconId = 0
    @XD.s32("tid") teamId = 0
    @XD.str("t_name") teamName = "Asphyxia"
    @XD.str("lid") lobbyId = "ea"
}
export class Rb6Comment extends RbCommentBase<6> {
    @XD.s16("chara") characterId = 0
    @XD.str("lid") lobbyId = "ea"
}

export const rbCommentTypeToken: TypeToken<RbCommentBase<RbVersion>> = Symbol()

export function getRbCommentType<TVersion extends RbVersion>(version: TVersion): Type<RbCommentBase<TVersion>> {
    switch (version) {
        case 2: return Rb2Comment as unknown as Type<RbCommentBase<TVersion>>
        case 3: return Rb3Comment as unknown as Type<RbCommentBase<TVersion>>
        case 4:
        case 5: return Rb4Comment as unknown as Type<RbCommentBase<TVersion>>
        case 6: return Rb6Comment as unknown as Type<RbCommentBase<TVersion>>
...
export class RbComments<TVersion extends RbVersion> {
    ...
    @XD.a(rbCommentTypeToken) c?: RbCommentBase<TVersion>[]
    @XD.a(rbCommentTypeToken) cf?: RbCommentBase<TVersion>[]
    @XD.a(rbCommentTypeToken) cs?: RbCommentBase<TVersion>[]
    @XD.a(rbCommentTypeToken) ct?: RbCommentBase<TVersion>[]
}
