...
export function registerRb1Handlers() {
    H.route("player.rb1start", startPlayer)
    H.route("player.rb1read", readPlayer)
    H.route("player.rb1write", writePlayer)
    H.route("log.rb1player", logPlayer)
    H.route("lobby.rb1entry", createAddLobbyHandler(1))
    H.route("lobby.rb1read", createReadLobbyHandler(1))
    H.route("lobby.rb1delete", createDeleteLobbyHandler(1))
}
